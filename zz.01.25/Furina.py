...
questions = [
     ...
     {"question": "Кого Райден изтрила(бг) в пепел?", "options": ["Синьору", "Арликину", "Дотторе", "Капитано"], "answer": "Синьору"},
     ...
     {"question": "Невиллет, кто он?", "options": ["Гидро дед", "Гидро Архонт", "Гидро дракон", "Верховный судья"], "answer": "Верховный судья"},
     {"question": "Казнь Фокалорс помогло спасти?", "options": ["Фурину от смерти", "ЦЕЛЫЙ Фонтейн от пророчества", "Людей от смерти", "Нёвиллету статть Архонтом"], "answer": "ЦЕЛЫЙ Фонтейн от пророчества"},
     ...
     {"question": "Мавуика и Фурина что делали 500 лет?", "options": ["ждали день предназночение", "правили", "ничего", "хранили Серце Бога"], "answer": "ждали день предназночение"},
     {"question": "Какой компаньон НЕ связан с хозяйном?", "options": ["Заец - Яо Яо", "Карбалета - Фурина", "Кот - Арлекино", "Пингвин - Фремине"], "answer": "Кот - Арлекино"}
]
